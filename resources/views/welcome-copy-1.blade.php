            ...
            <form id="submitPersonal" enctype="multipart/form-data" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label class="col-3 required">Kontak Darurat 1</label>
                            <div class="col-9">
                                <input type="number" id="darurat1" name="darurat1"
                                    class="form-control form-control-sm text-uppercase">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 required">Hubungan dengan Kontak Darurat 1</label>
                            <div class="col-9">
                                <select class="form-control form-control-sm text-uppercase" id="hubungan1"
                                    name="hubungan1">
                        ...
                        <div class="form-group row">
                            <label class="col-3 required">Kontak Darurat 2</label>
                            <div class="col-9">
                                <input type="number" id="darurat2" name="darurat2"
                                    class="form-control form-control-sm text-uppercase">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 required">Hubungan dengan Kontak Darurat 2</label>
                            <div class="col-9">
                                <select class="form-control form-control-sm text-uppercase" id="hubungan2"
                                    name="hubungan2">
                                    <option value="">--- PILIH ---</option>
                                    <option value="AYAH">AYAH</option>
                                    <option value="IBU">IBU</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <hr>
                        <div class="form-group row">
                            <label class="col-3 required">Alamat</label>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            <label class="col-3 required">Nomor</label>
                            <div class="col-3">
                                <input type="number" id="noRumahKtp" name="noRumahKtp"
                                    class="form-control form-control-sm">
                            </div>
                            <label class="col-1 required">RT</label>
                            <div class="col-2">
                                <input type="number" id="rtKtp" name="rtKtp"
                                    class="form-control form-control-sm text-uppercase">
                            </div>
                            <label class="col-1 required">RW</label>
                            <div class="col-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="Tidak selectts">
                            ...
                            <div class="form-group row">
                                <label class="col-3 required">Nomor</label>
                                <div class="col-3">
                                    <input type="number" id="noRumahDomisili" name="noRumahDomisili"
                                        class="form-control form-control-sm text-uppercase">
                                </div>
                                <label class="col-1 required">RT</label>
                                <div class="col-2">
