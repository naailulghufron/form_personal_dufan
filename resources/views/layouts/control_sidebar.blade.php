<div
    ...
    <div class="os-padding">
        <div class="os-viewport os-viewport-native-scrollbars-invisible">
            <div class="os-content" style="padding: 16px; height: 100%; width: 100%;">
                ...
                <hr class="mb-2">
                <h6>System</h6>
                <a href="{{ route('register') }}" class="nav-link">User Registration</a>
                {{-- <a href="{{ route('plant.index') }}" class="nav-link">Plant</a>
                <a href="{{ route('department.index') }}" class="nav-link">Department</a>
                <a href="{{ route('section.index') }}" class="nav-link">Section</a>
                <a href="{{ route('team.index') }}" class="nav-link">Team</a> --}}

                <h6>Classification</h6>
                {{-- <a href="{{ route('fa_category.index') }}" class="nav-link">FA Category</a> --}}
    ...
    <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
        <div class="os-scrollbar-track">
            <div class="os-scrollbar-handle" style="transform: translate(0px, 0px); height: 52.7864%;"></div>
        </div>
    </div>
